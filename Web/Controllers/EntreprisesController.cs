...
namespace Web.Controllers
{
    public class EntreprisesController : Controller
    {
        ...
        public EntreprisesController(RepertoireContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EntrepriseId,Nom,AdresseId")] Entreprise entreprise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EntrepriseId,Nom,AdresseId")] Entreprise entreprise)
        {
